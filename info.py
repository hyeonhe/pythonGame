...
#         self.x_pos = (screen_width / 2) - (self.rect[0] / 2)
#         self.y_pos = screen_height - self.rect[1] - screen_height
...
# character = pygame.image.load(os.path.join(image_path, "character.svg"))
character = pygame.image.load(os.path.join(
    image_path, "character.svg")).convert_alpha()
# character = pygame.transform.scale(character)

# character.mask = pygame.mask.from_surface(character)
