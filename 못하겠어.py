...
while running:
    ...
    # print(character.rect.left, character.rect.top)
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # ball_rect.mask = pygame.mask.from_surface(ball_images[ball_img_idx])
        ...
        # for i in balls:
        #     Ball(ball_images(balls[i]["img_idx"])).mask = pygame.mask.from_surface(
        #         Ball(balls[i]["img_idx"]).image)
        #     a.mask = pygame.mask.from_surface(a.image)
        #     a = list(a)
        #     ballss.append(a)

        # if pygame.sprite.collide_mask(balls, character):
        #     running = False
        #     break
        #     print("충돌")
        ...
        for weapon.idx, weapon.val in enumerate(weapons):
            ...
            # if pygame.sprite.collide_mask(weapon, Ball(ball_images[ball_img_idx])):
