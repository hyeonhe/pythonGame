...
def game():
    ...
    background = pygame.image.load(
        os.path.join(image_path, "background.svg"))
    ...
    character = pygame.image.load(
        os.path.join(image_path, "character.svg"))
    ...
    # 무기 만들기
    weapon = pygame.image.load(os.path.join(image_path, "weapon.svg"))
...
####################################################
        ...
        for idx, val in enumerate(balls):
            ...
            screen.blit(ball_images[ball_img_idx],
...
##################### 추가한 부분 #######################
    restart = pygame.image.load(os.path.join(image_path, "RESTART.svg"))
    gamequit = pygame.image.load(os.path.join(image_path, "QUIT.svg"))

    screen.blit(restart, (160, 320))
    screen.blit(gamequit, (366, 320))
    ...
    while rerunning:
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            if 320 < mouse_pos[1] < 376:
                if 160 < mouse_pos[0] < 274:
                    return game()
                elif 366 < mouse_pos[0] < 480:
                    pygame.quit()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                rerunning = False
