...
import pygame
# sys.path.append(
# 'C:\\Users\\user\\Documents\\pythonExam\\pygame_project\\info.py')
##############################################################
# 기본 초기화 (반드시 해야 하는 것들)
pygame.init()
...
while whole:
    ...
    running = False
    if main_run == False and quitbool == False:
        running = False
    else:
        running = True
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:  # 캐릭터를 왼쪽으로
                    ...
                    weapon_x_pos = character.x_pos + \
                        (character.width / 2) - (weapon_width / 2)
